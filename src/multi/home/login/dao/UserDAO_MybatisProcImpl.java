...
public class UserDAO_MybatisProcImpl implements UserDAO{
	...
	public UserVO find_user(UserVO uvo) throws Exception {
		return sqlSession.selectOne("home_login_proc.home_login",uvo);
	}
	@Override
	public UserVO find_userInfo(String user_id) throws Exception {
		return sqlSession.selectOne("home_login_proc.home_loginFindUserInfo",user_id);
	}
	@Override
	public UserVO find_userId(UserVO uvo) throws Exception {
		return sqlSession.selectOne("home_login_proc.home_loginFind_userId",uvo);
	}
	@Override
	public UserVO find_userPasswd(UserVO uvo) throws Exception {
		return sqlSession.selectOne("home_login_proc.home_loginFind_userPasswd",uvo);
	}
