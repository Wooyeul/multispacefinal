...
public class CtrlClub_notice {
	...
	public ModelAndView club_add_community_notice(@ModelAttribute ClubVO pvo) throws Exception {
	...
	public ModelAndView club_notice_detail(@ModelAttribute Club_noticeVO pvo) throws Exception {
