...
public class PaginationDTO_review {
	public static int pageSize = 5; // 한 페이지에 보일 게시글 갯수
	public static int paginationSize = 5;  // 10개짜리 글이 들어있는 리스트를 몇개까지 보여줄것인가.
	
	public PaginationDTO_review init(String pg, int countAll ) {
