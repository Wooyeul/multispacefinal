...
window.onload = function() {
	e("btn").onclick = function() {
		...
		ajaxGet("community_board_recom.do" + dc
...
<body>
	...
	<table class="table ">
		...
		<tr>
			...
			<a href="community_board_repledel.do?com_board_reple_no=${vo2.com_board_reple_no}&com_board_no=${vo2.com_board_no}">[x] </a>
			 </td>
			<td>${vo2.the_time}</td>
			<td>${vo2.user_id}</td>
	...
	<form action="community_board_del.do" method="POST">
		<input type="hidden" name="com_board_no" value="${vo.com_board_no}" /> 
