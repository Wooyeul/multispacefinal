					...
					<form name="agreeFrm">
						<div
							...
							<p style="margin: 10px;">
								...
								- 공간대여<br /> - 커뮤니티 등록 및 관리<br /> - 공간등록<br /> - 문의게시판<br />
								나. 위의 서비스를 받기 위해서는 사용자 로그인을 하셔야 합니다.<br /> 다. 홈페이지의 서비스는 지속적으로
								추가 제공될 것이며, 불가피한 사정에 의해 서비스의 내용을 변경하거나 중단할 수 있습니다.<br /> 라.
								서비스가 변경되거나 중단되는 경우 회원에게 홈페이지를 통해서 공지합니다.<br />
							</p>
							<p style="margin: 10px;">
								5. 회사는 다음 각 호에 해당하는 이용계약 신청에 대하여는 이를 승낙하지 아니 합니다.<br /> 가. 다른
								사람의 명의를 사용하여 신청하였을 때<br /> 나. 본인의 실명으로 신청하지 않았을 때<br /> 다. 이용
								계약 신청서의 내용을 허위로 기재하였을 때<br /> 라. 사회의 안녕과 질서 혹은 미풍양속을 저해할 목적으로
								신청하였을 때 6. ID와 비밀번호<br /> 가. ID와 비밀번호에 관한 모든 관리책임은 이용자에게 있습니다.
								이용자에게 부여된 ID 및 비밀번호의 관리소홀, 부정사용에 의하여 발생하는 모든 결과에 대한 책임은 이용자에게
								있습니다. 자신의 ID가 부정하게 사용된 경우 이용자는 반드시 홈페이지 웹마스터에게 전화나 이메일(
								1588-3357 / webmaster@multicampus.co.kr)로 그 사실을 통보해야 합니다.<br />
								나. 비밀번호는 다음의 사항을 준수하여 신청하여야 합니다.<br /> - 6자 이상으로 설정하셔야 합니다.<br />
								- 영문자와 숫자를 혼용하셔야 합니다.<br /> - ID가 포함되거나 동일하지 않아야 합니다.<br /> -
								동일한 문자가 4회 이상 연속되어서는 안됩니다.<br /> - 위 사항의 모든 사항에 부합되어야 정식으로
								회원가입을 하실 수 있습니다.<br />
							</p>
							<p style="margin: 10px;">
						...
						<div>
							<div
								...
								<p style="margin: 10px;">
									...
									이행 및 서비스 제공에 따른 요금정산 목적<br /> 학습진행, 컨텐츠 제공, 구매 및 요금 결제, 물품배송
									또는 청구지 등 발송<br /> - 회원 관리<br /> 회원제 서비스 이용에 따른 본인확인, 개인 식별,
									불량회원의 부정 이용 방지와<br /> 비인가사용 방지, 가입 의사 확인, 연령확인, 불만처리 등 민원처리,
									고지사항 전달<br /> - 마케팅 및 광고에 활용<br /> 신규 서비스(제품) 개발 및 특화, 이벤트 등
									광고성 정보 전달, 인구통계학적 특성에 따른<br /> 서비스 제공 및 광고 게재, 접속 빈도 파악 또는 회원의
									서비스 이용에 대한 통계 <br /> - 고용보험 과정의 노동부 신고 <br /> 회원이 신청한 과정이
									고용보험 대상 과정인 경우 고용보험 환급을 이유로 노동부에 신고하게 됩니다.<br />
								</p>
						...
						<div>
							<div
								style="width: 650px; height: 100px; border: 1px solid #333; overflow: auto">
								<p style="margin: 10px;">
									원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.<br /> 단,
								...
								<p style="margin: 10px;">
									...
									회원정보를 보관합니다.<br /> 1) 기타 법령에 따른 보유기간/관계법 안내<br /> - 계약 또는
									청약철회 등에 관한 기록 : 5년 (전자상거래 등에서의 소비자 보호에 관한 법률)<br /> - 대금결제 및
									재화 등의 공급에 관한 기록 : 5년 (전자상거래 등에서의 소비자 보호에 관한 법률)<br /> - 소비자의
									불만 또는 분쟁처리에 관한 기록 : 3년 (전자상거래 등에서의 소비자 보호에 관한 법률)<br /> -
